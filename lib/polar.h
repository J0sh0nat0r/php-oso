/**
 *  NOTE: We drop the const from strings in returned values and `string_free` to avoid PHP automatically converting
 *        them to managed strings. See: https://github.com/dstogov/php-ffi/issues/42
 */
